...
void SceneManager::CreateQuadMesh(int resolution)
{
...
bool SceneManager::LoadQuadMeshScene(const std::string &scenePath, int resolution)
{
  ...
  if (res < 0)
  {
    RUN_TIME_ERROR("LoadQuadMeshScene error");
    return false;
  }

  CreateQuadMesh(resolution);
